...
// блок — один день (за Києвом). Колонки — як запропонував користувач 26.09.2026:
// Помилки · Оброблено категорій (N з M) · Тривалість. «Помилки рендеру» й «без
// актуальної мапи» з концепту згорнуті в них: перше — помилки, друге — різниця
// між N і M.

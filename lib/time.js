...
// ГГ:ХХ — у таблиці прогону, де дата стоїть один раз у заголовку
const fmtTime = date => { const p = parts(date); return `${p.hour}:${p.minute}`; };

module.exports = { TZ, fmtDate, fmtDateTime, fmtStamp, fmtTime };

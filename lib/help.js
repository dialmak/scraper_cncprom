...
const helpMenuHtml = (termsTip) => `
      <div class="hdr-menu">
        ...
        <div class="hdr-dropdown right" id="help-dropdown">
          ...
          <div>${menuRow(ICONS.about, 'Що це таке', 'about-overlay', 'Що це за проєкт і як він працює')}${menuRow(ICONS.legend, 'Що означають цифри та позначки', 'help-overlay', termsTip)}${menuRow(ICONS.credits, 'Про проєкт і подяки', 'credits-overlay', 'Хто зробив і на чому все це зроблено')}
          </div>
        </div>
      </div>`;
  ...
  <div class="help-overlay" id="about-overlay">
    <div class="help-panel">
      ...
      <div class="help-panel-body">
        ...
        <div class="help-term">
          <div class="help-term-label">Перевірки та звірки</div>
  ...
  <div class="help-overlay" id="credits-overlay">
    <div class="help-panel">
      ...
      <div class="help-panel-body">
        ...
        <p class="failed-note">Використані технології та компоненти:</p>
